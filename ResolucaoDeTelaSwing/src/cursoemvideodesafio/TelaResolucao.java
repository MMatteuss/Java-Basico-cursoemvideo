...
public class TelaResolucao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgens/resolução tela.png"))); // NOI18N

        jLabel2.setText("Resolução de teka");
        ...
        lblMsg.setForeground(new java.awt.Color(38, 38, 38));
        lblMsg.setText("Click no botão");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lblMsg.setText(d.width+" X "+d.height);
